...
# TODO: Ship movement is a little jittery. - CP
...
class Ship():
    def __init__(self):
        ...
        # TODO: Image loading needs to be abstracted.
    ...
    def update(self, dt):
        # TODO: Should accept WASD input as well.
        
        direction = 0
        if InputWatcher.isDown(pygame.K_LEFT):
            direction -= 1
        if InputWatcher.isDown(pygame.K_RIGHT):
            direction += 1
    ...
    def getWorldVelocity(self):
        # TODO: This doesn't work when you are near edge of screen. It just goes where you are pushing your button = CP
